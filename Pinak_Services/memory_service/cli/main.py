...
def mint(tenant: str, project: str = "default", secret: str = None):
    ...
    # 🛡️ Sentinel: Removed hardcoded fallback secret to prevent unauthorized token generation.
...
def search(query: str, tenant: str = "demo", project: str = "default", url: str = "http://localhost:8001"):
    ...
    # 🛡️ Sentinel: Removed hardcoded fallback secret to prevent unauthorized access.
