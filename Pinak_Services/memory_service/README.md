...
```bash
# If PINAK_JWT_SECRET was generated by ./pinak-memory, use that value.
export PINAK_JWT_SECRET="your-generated-secret"
...
### 1) Register Client
```bash
# Set your secure secret
export PINAK_JWT_SECRET="your-secure-secret-here"
