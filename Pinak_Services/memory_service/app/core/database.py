...
class DatabaseManager:
    ...
    def _init_db(self):
        with self.get_cursor() as conn:
            ...
            """)
            # ⚡ Bolt: Added composite indexes to prevent full table scans and significantly speed up multi-tenant queries
            # across layers (often invoked by `get_client_layer_stats` and `get_memories_by_embedding_ids`).
