...
class DatabaseManager:
    ...
    def _init_db(self):
        with self.get_cursor() as conn:
            ...
            """)
            conn.execute("""
                CREATE INDEX IF NOT EXISTS idx_memories_semantic_vec
            ...
            """)
            conn.execute("""
                CREATE INDEX IF NOT EXISTS idx_memories_episodic_vec
            ...
            """)
            conn.execute("""
                CREATE INDEX IF NOT EXISTS idx_memories_procedural_vec
