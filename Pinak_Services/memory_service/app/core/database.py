    ...
    def _init_db(self):
        with self.get_cursor() as conn:
            ...
            conn.execute("""
                ...
                END;
            """)
            # ⚡ Bolt: Multi-tenant composite index for semantic memory
            conn.execute("""
            ...
            conn.execute("""
                ...
                END;
            """)
            # ⚡ Bolt: Multi-tenant composite index for episodic memory
            conn.execute("""
            ...
            conn.execute("""
                ...
                END;
            """)
            # ⚡ Bolt: Multi-tenant composite index for procedural memory
            conn.execute("""
            ...
            """)
            # ⚡ Bolt: Multi-tenant composite index for memory quarantine queries
            ...
            """)
            # ⚡ Bolt: Multi-tenant composite index for client issues queries
