...
class VectorStore:
    ...
    def __init__(self, index_path: str, dimension: int):
        ...
        # ⚡ Bolt: Use a list buffer for O(1) amortized inserts instead of O(N^2) vstack thrashing
    ...
    def _flush_buffers(self):
        """Helper to merge buffered additions into the main arrays before search/save."""
    ...
    def add_vectors(self, vectors: np.ndarray, ids: List[int]):
        ...
        with self.lock:
            # ⚡ Bolt: Buffer inserts to avoid N^2 array copies on frequent insertions
