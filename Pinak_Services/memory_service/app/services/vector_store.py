...
class VectorStore:
    ...
    def __init__(self, index_path: str, dimension: int):
        ...
        # ⚡ Bolt: List-based buffers for amortized O(1) insertions
    ...
    def _flush_buffers(self):
        # ⚡ Bolt: Flush buffered vectors into the main numpy arrays in one go to avoid O(N^2) vstacking overhead
    ...
    def add_vectors(self, vectors: np.ndarray, ids: List[int]):
        ...
        with self.lock:
            # ⚡ Bolt: Append to list buffer instead of full array copy
