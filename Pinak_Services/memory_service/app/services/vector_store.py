...
class VectorStore:
    ...
    def _flush_buffers(self):
        """Flush buffered vectors into the main arrays. Assumes lock is acquired."""
    ...
    def ntotal(self):
        with self.lock:
            return len(self.ids) + sum(len(arr) for arr in self._id_buffer)
