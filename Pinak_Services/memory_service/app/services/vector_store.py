...
class VectorStore:
    ...
    def __init__(self, index_path: str, dimension: int):
        ...
        # ⚡ Bolt: Use list-based buffers to achieve amortized O(1) additions
    ...
    @property
    def ntotal(self):
        # ⚡ Bolt: calculate total elements without merging arrays
    ...
    def _flush_buffers(self):
        # ⚡ Bolt: Amortize O(N) array reallocation by flushing list-based buffers only when needed
    ...
    def add_vectors(self, vectors: np.ndarray, ids: List[int]):
        ...
        with self.lock:
            # ⚡ Bolt: Append to list buffers instead of reallocating numpy arrays (O(N^2) -> O(1) amortized)
