...
class NudgeEngine:
    ...
    async def _identify_missing_context(
        self, user_id: str, project_id: str, context_items: List[ContextItem]
    ...
    def _analyze_trigger_events(
        self, trigger_events: List[Dict[str, Any]], context_items: List[ContextItem]
    ) -> List[Dict[str, Any]]:
        """
    ...
    def _analyze_security_context(
        ...
        high_security_items = [
            ...
            in [SecurityClassification.CONFIDENTIAL, SecurityClassification.RESTRICTED]
        ]

        recent_reviews = [
            item
            for item in high_security_items
    ...
    def _find_best_template(
        self, opportunity: Dict[str, Any], templates: List[NudgeTemplate]
    ...
    def _template_matches_opportunity(
        self, template: NudgeTemplate, opportunity: Dict[str, Any]
    ) -> bool:
        """
        Check if template conditions match the opportunity.
        """
    ...
    async def _personalize_nudge_content(
        self, template: NudgeTemplate, opportunity: Dict[str, Any], user_id: str
    ) -> Dict[str, Any]:
        """
