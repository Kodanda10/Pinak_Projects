...
def main(argv: List[str] | None = None) -> int:
    ...
    health_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
    health_parser.add_argument('--token', default=os.getenv("PINAK_TOKEN"), help="Bearer token")

    # Search command
    search_parser = subparsers.add_parser('search', help='Search memory')
    search_parser.add_argument('query', help='Search query')
    search_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
    search_parser.add_argument('--token', default=os.getenv("PINAK_TOKEN"), help="Bearer token")
    search_parser.add_argument('--layers', default="episodic,procedural,rag", help="Layers for search")
    ...
    add_parser.add_argument('--layer', required=True, choices=['episodic', 'procedural', 'rag', 'events', 'session', 'working'], help='Memory layer')
    add_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
    add_parser.add_argument('--token', default=os.getenv("PINAK_TOKEN"), help="Bearer token")
    add_parser.add_argument('--salience', type=int, default=5, help="Salience score for episodic memory (0-10)")
    ...
    episodic_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
    ...
    procedural_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
    ...
    rag_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
    ...
    events_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
    ...
    session_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
    ...
    working_parser.add_argument('--url', default=os.getenv("PINAK_MEMORY_URL"), help="Memory API base URL")
