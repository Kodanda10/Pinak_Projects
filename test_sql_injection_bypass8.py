...
# The issue is that we can append any valid SQL string for column name.
# What if we want to overwrite 'secret' column but bypass verification?
updates = {"id = '1', secret": "hacked"}
