        ...
        for line in lines:
            ...
            if line.strip().startswith(('import ', 'from ')):
                ...
                if any(unused in line for unused in [
                    'os', 'sys', 'json', 'shutil', 'subprocess', 'time',
                    'datetime.datetime', 'datetime.timezone', 'asyncio',
                    'typing.Optional', 'typing.Dict', 'typing.List',
                    'typing.Any', 'typing.Set', 'typing.Tuple', 'typing.Union',
                    'typing.AsyncIterator', 'typing.Iterator', 'heapq',
                    'collections.deque', 're', 'builtins', 'types'
                ]):
